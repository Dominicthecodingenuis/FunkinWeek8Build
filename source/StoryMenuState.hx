...
class StoryMenuState extends MusicBeatState
{
	...
	var weekNames:Array<String> = ";Daddy Dearest;Spooky Month;PICO;MOMMY MUST MURDER;RED SNOW;hating simulator ft. moawling;TANKMAN;Pico's school 3 ft. ivanAlmighty".split(";");
